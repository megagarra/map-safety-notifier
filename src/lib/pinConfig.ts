export const PIN_CONFIG: Record<string, { label: string; color: string; border: string; bg: string; icon: string }> = {
  infraestrutura: {
...
export function getPinConfig(type: string) {
  return PIN_CONFIG[type] || PIN_CONFIG.infraestrutura;
}
